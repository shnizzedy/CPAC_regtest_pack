...
#bids_dir="s3://fcp-indi/data/Projects/HBN/MRI/Site-CBIC"
#bids_dir="s3://fcp-indi/data/Projects/CORR/RawDataBIDS/HNU_1"

# Pipeline
#pipe_config="/media/ebs/runs/configs/pipeline_config_regtest-4.yml"
#preconfig="benchmark-ANTS" # preconfig will override pipe_config
...
if [[ -z "$data_config" ]]
then
    # if bids_dir = an S3 path, can't do the mapping below
