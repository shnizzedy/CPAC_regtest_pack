...
sudo docker run \
    ...
    -v /media/ebs/runs/fmriprep-opt_$run_name:/output \
    -v /media/ebs/runs/fmriprep-opt_v161a-hotfix/cpac_pipeline_config_2020-02-28T23-28-52Z.yml:/configs/pipe.yml \
