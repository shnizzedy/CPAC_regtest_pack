...
sudo docker run \
    ...
    -v /media/ebs/CPAC_regtest_pack/configs:/configs \
    -v /media/ebs/v150/lei-xcp:/output \
    fcpindi/c-pac:release-v1.5.0 s3://fcp-indi/data/Projects/CORR/RawDataBIDS/HNU_1 /output participant \
    --save_working_dir \
    --n_cpus 4 \
    --mem_gb 12 \
    --pipeline_file /configs/cpac_pipeline_config_2019-12-19T12-29-05Z.yml \
