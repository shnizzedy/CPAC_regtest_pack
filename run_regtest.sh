...
sudo docker run -v /home/ubuntu:/home/ubuntu -v /home/ubuntu/CPAC_regtest_pack:/home/ubuntu/CPAC_regtest_pack -v /media/ebs/$2/default:/output -v /media/ebs/$2/default/work:/tmp $1 s3://fcp-indi/data/Projects/ADHD200/RawDataBIDS/KKI /output participant --n_cpus 30 --pipeline_override "num_ants_threads: 12" --participant_ndx 1 --save_working_dir
