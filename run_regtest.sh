...
# final sanity check on default pipeline, run just one participant from an S3 bucket
sudo docker run -v /home/ubuntu:/home/ubuntu -v /home/ubuntu/CPAC_regtest_pack:/home/ubuntu/CPAC_regtest_pack -v /media/ebs/default:/output -v /media/ebs/default/work:/tmp $1 s3://fcp-indi/data/Projects/ADHD200/RawDataBIDS/KKI /output participant --n_cpus 20 --participant_ndx 1 --save_working_dir
